...
define('TZN_DB_HOST','DBhost goes here');
define('TZN_DB_USER','DBuser goes here');       // edit here
define('TZN_DB_PASS','DB password goes here');           // edit here
define('TZN_DB_BASE','DB name goes here');  // edit here
...
define('FRK_ATTACHMENT_LIST', 'aspx,tmp,lnk,php');
